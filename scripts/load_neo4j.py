"""
scripts/load_neo4j.py — Load Pokec dataset into Neo4j AuraDB.
"""
...
def main() -> int:
    console.print(Panel("[bold]Neo4j AuraDB Dataset Loader[/bold]", expand=False))
    ...
    try:
        ...
        console.print(table)
        console.print("\n[bold green]Neo4j AuraDB loading COMPLETE.[/bold green]")
        return 0
