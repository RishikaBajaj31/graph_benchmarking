"""
scripts/load_falkordb.py — Load Pokec dataset into FalkorDB.
"""
...
def main() -> int:
    console.print(Panel("[bold]FalkorDB Dataset Loader[/bold]", expand=False))

    try:
        metrics = load_falkordb()
        ...
        console.print(table)
        console.print("\n[bold green]FalkorDB loading COMPLETE.[/bold green]")
        return 0
