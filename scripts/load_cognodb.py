"""
scripts/load_cognodb.py — Load Pokec dataset into CognoDB Cloud.
"""
...
def main() -> int:
    console.print(Panel("[bold]CognoDB Cloud Dataset Loader[/bold]", expand=False))

    try:
        metrics = load_cognodb()
        ...
        console.print(table)
        console.print("\n[bold green]CognoDB loading COMPLETE.[/bold green]")
        return 0
